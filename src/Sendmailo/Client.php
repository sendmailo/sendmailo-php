...
class Client
{
     ...
     *
     * @param string $key Sendmailo API Key
     * @param string|null $secret Sendmailo API Secret
     ...
     *
     * @param array $resource Sendmailo Resource/Action pair
    ...
    /**
     * Magic method to call a sendmailo resource.
     *
     * @param string $method Http method
     * @param string $resource sendmailo resource
     * @param string $action sendmailo resource action
     * @param array $args Request arguments
     *
     ...
     * @param string $resource Sendmailo resource
     * @param string $action Sendmailo resource action
     * @param string $id sendmailo resource id
     * @param string $actionid sendmailo resource actionid
     *
    ...
    private function buildURL(string $resource, string $action, string $id, string $actionid): string
    {
        ...
        if (\in_array($resource, $this->smsEndpoints, true)) {
            $path = '';
